...
class _BlocCounterView extends StatelessWidget {
  ...
  void increaseCounterBy(BuildContext context, [int value = 1]) {
    ...
    // context.read<CounterBloc>().increaseBy(value); // otra opcion de hacer lo mismo que la linea de arriba con funcion opc1
  }
        ...
        actions: [
          IconButton(
              onPressed: () =>
                  ...
                  // context.read<CounterBloc>().resetCounter(), // otra opcion de hacer lo mismo que la linea de arriba con funcion opc1
